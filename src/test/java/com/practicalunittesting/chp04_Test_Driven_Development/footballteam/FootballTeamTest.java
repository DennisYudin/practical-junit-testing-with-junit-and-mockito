...
public class FootballTeamTest {
	...
	public void constructorShouldSetGamesWon(int expectedNumberOfGamesWon) {
		FootballTeam team = new FootballTeam(expectedNumberOfGamesWon);

		//assertEquals(nbOfGamesWon, team.getGamesWon(), 3);
		int actualGamesWon = team.getGamesWon();

		assertEquals(expectedNumberOfGamesWon + " games passed to constructor, " +
				"but " + team.getGamesWon() + " were returned",
				expectedNumberOfGamesWon, actualGamesWon);
	}
	...
	public void teamWithMoreMatchesWonShouldBeGreater() {
		...
		String message = "team with " + team_3.getGamesWon() + " games won should be ranked before " +
				"team with " + team_2.getGamesWon() + " games won";

		assertTrue(message, team_3.compareTo(team_2) > 0);
	}
